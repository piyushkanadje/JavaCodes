...
public class CarPriceEstimators {
  ...
  // greetings = "hello " + (user.male()   ? "Mr" : "Mrs");
	...
	public static void main(String[] args) {
		CarPriceEstimators carPriceEstimator = new CarPriceEstimators();
		double salesPrice = carPriceEstimator.getSalePrice("ford ecosport", 2018, 60000.0, 2, true, false, true, false,
				false, true);
	}
}
